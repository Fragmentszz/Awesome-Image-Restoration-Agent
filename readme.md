...
- [Image Super-Resolution (SR)](#image-super-resolution-sr)
- [Image Restoration (IR)](#image-restoration-ir)
  - [Denoising & Deblurring](#denoising--deblurring)
  - [Colorization & Enhancement](#colorization--enhancement)
- [Agent Frameworks for Vision](#agent-frameworks-for-vision)
...
1. Follow the exact format of the existing entries.
